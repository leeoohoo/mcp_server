...
export function createShellServer(options) {
    const { serverName, workspaceRoot, defaultTimeoutMs, maxOutputBytes, allowCommands, denyCommands, } = options;
    ...
    server.registerTool('run_shell', {
        ...
        description: [
            ...
            `Max output: ${formatBytes(maxOutputBytes)}.`,
